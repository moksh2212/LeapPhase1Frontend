...
import {
  Button, Grid, Typography, Paper, Snackbar, Alert
} from '@mui/material';
...
const RegularizeRequestTable = ({ requests, onApprove, onReject, isPendingTab}) => {
  ...
  const columns = [
    ...
    { field: 'talentName', headerName: 'Employee Name', flex: 1, sortable: false },
    ...
    { field: 'approvalManager', headerName: 'Approval Manager', flex: 1, sortable: false },
    isPendingTab && {
      field: 'actions',
      headerName: 'Actions',
      flex: 1,
