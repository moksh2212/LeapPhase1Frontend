...
export function AddMembers({ openModal, setOpenModal, createMember }) {
  ...
  const handleSubmit = async e => {
    ...
    for (const talent of selectedTalents) {
      ...
      try {
        ...
        console.log(`Form submitted successfully for talentId: ${talent.talentId}`);
      } catch (error) {
        console.error(`Error submitting form for talentId: ${talent.talentId}`, error);
      }
    }
  };
  ...
  const handleSelectChange = useCallback((e) => {
    ...
    const newSelectedTalents = filteredTalentList.filter(talent => selectedValues.includes(talent.email));
    setSelectedTalents(prevSelected => [
      ...prevSelected.filter(talent => !selectedValues.includes(talent.email)),
      ...newSelectedTalents,
    ]);
  }, [filteredTalentList]);
