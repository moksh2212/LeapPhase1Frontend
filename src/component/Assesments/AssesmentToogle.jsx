    ...
    () => [
      {
        ...
        columns: [
          ...
          {
            accessorKey: 'assessmentSkill', //hey a simple column for once
            ...
            <Box>
              <Box sx={{ display: 'flex', gap: '0.5rem' }}>
                <div>
                  ...
                  <h2 class="p-2 border-3 border-gray-300 rounded bg-blue-100 text-gray-700 ">Assignment Wise View</h2>
                <div>
...
export default AssesmentToogle
